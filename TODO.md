...
- [x] 전투 시스템 개선 및 밸런싱
  - [x] 적을 빨간 사각형으로 표시 (isDummy 플래그)
  - [x] 적 자동 공격 버그 수정
  - [x] 공격 범위 불투명도 증가 (0.3 → 0.6)
  - [x] 적 5초 후 자동 리스폰
  - [x] 대미지 밸런싱 (적 30HP/3방, 플레이어 100HP/10방)
  - [x] 샤드 개별 리스폰 시스템 (3~5초 랜덤)

- [x] 멀티플레이어 전투 동기화
  - [x] 플레이어 공격 서버 동기화 (playerAttack 이벤트)
  - [x] 서버 측 데미지 계산 및 브로드캐스트
  - [x] 플레이어 HP 동기화 (playerDamaged 이벤트)
  - [x] 로컬/원격 플레이어 HP 실시간 업데이트
