...
describe('Canvas Resizing', () => {
    ...
    function calculateCanvasSize(windowWidth: number, windowHeight: number): CanvasSize {
...
describe('Delta Time', () => {
    function calculateDeltaTime(lastFrameTime: number, currentFrameTime: number): number {
...
describe('findNearestEnemy', () => {
    ...
    function createDummy(x: number, y: number, alive = true): Enemy {
        return {
            x,
            y,
            isAlive: () => alive,
    ...
    function createRemotePlayer(x: number, y: number, alive = true): Enemy {
        return {
            x,
            y,
            isAlive: () => alive,
    ...
    function findNearestEnemy(
        ...
        let nearestEnemy: EnemyResult | null = null;
...
describe('findRandomEnemy', () => {
    ...
    function findRandomEnemy(dummies: Enemy[], remotePlayers: Enemy[]): EnemyResult | null {
        const enemies: EnemyResult[] = [];
...
describe('Hit Vignette Effect', () => {
    ...
    function getVignetteOpacity(state: VignetteState): number {
...
describe('Death Screen', () => {
    ...
    function getRespawnTime(player: DeadPlayer): number {
...
describe('Attack Cooldown', () => {
    ...
    function canSendAttack(lastAttackSentTime: number, attackCooldown: number): boolean {
