...
class Skill {
    ...
    constructor(name: string, key: string, cooldown: number, iconColor = '#666666') {
        this.name = name;
        this.key = key;
...
class TelepathyEffect {
    ...
    getDamageArea(): TelepathyDamageArea {
        return {
            x: this.x,
            y: this.y,
            radius: this.radius,
