...
describe('Enemy Finder Module', () => {
    ...
    function createDummy(x: number, y: number, alive = true): Dummy {
        return {
            x,
            y,
            isAlive: () => alive,
    ...
    function createRemotePlayer(x: number, y: number, alive = true): RemotePlayer {
        return {
            x,
            y,
            isAlive: () => alive,
    ...
    function findRandomEnemy(dummies: Dummy[], remotePlayers: RemotePlayer[]): Enemy | null {
        const enemies: Enemy[] = [];
