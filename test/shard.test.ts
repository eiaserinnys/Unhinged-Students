...
class Shard {
    ...
    constructor(x: number, y: number, size = 20, id: string | null = null) {
        this.x = x;
        this.y = y;
        this.size = size;
        this.id = id;
    ...
    checkCollision(character: Character): boolean {
...
describe('Shard', () => {
    ...
    describe('checkCollision', () => {
        test('should detect collision with character', () => {
            ...
            const character: Character = { x: 110, y: 100, width: 50 };
        ...
        test('should not detect collision when far away', () => {
            const shard = new Shard(100, 100);
            const character: Character = { x: 500, y: 500, width: 50 };
        ...
        test('should not collide when already collected', () => {
            ...
            const character: Character = { x: 100, y: 100, width: 50 };
        ...
        test('should use character width and shard size for collision', () => {
            ...
            const character: Character = { x: 100, y: 100, width: 100 }; // 50 radius
        ...
        test('should handle diagonal distance correctly', () => {
            ...
            const character: Character = { x: 50, y: 50, width: 50 }; // 25 radius
...
class ShardManager {
    ...
    loadShardsFromServer(shardData: ShardData[]): void {
        this.shards = [];
    ...
    addShardsFromServer(shardData: ShardData[]): void {
        shardData.forEach((data) => {
    ...
    spawnShards(count: number, canvasWidth: number, canvasHeight: number, margin = 100): void {
    ...
    spawnSingleShard(margin = 100): void {
    ...
    checkCollisions(character: Character): Shard[] {
